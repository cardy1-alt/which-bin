...
export const ITEMS = [
  ...
  { emoji: "🍦", name: "a rinsed yoghurt pot", answer: "recycling", diff: 1, reveal: "recycling. the pot, yes. the foil film lid? general, until 2027, obviously." },
  ...
  { emoji: "🥤", name: "an empty crisp packet", answer: "general", diff: 2, reveal: "general waste. soft plastic, 'coming 2027', the council's favourite phrase for 'not our problem yet'." },
  ...
  { emoji: "🍫", name: "a chocolate bar wrapper", answer: "general", diff: 3, reveal: "general waste. soft plastic, 'not until 2027'. the wrapper will outlive us all." },
  { emoji: "🫧", name: "a wad of bubble wrap", answer: "general", diff: 3, reveal: "general waste. soft plastic. pop it for closure, then bin it in the bin that feels wrong." },
  ...
  { emoji: "🛍️", name: "a carrier bag stuffed with recycling", answer: "general", diff: 2, reveal: "general waste, and never bag your recycling. they bin the whole lot, bag and all, out of spite." },
  ...
  { emoji: "🧊", name: "an empty frozen veg bag", answer: "general", diff: 2, reveal: "general waste. film plastic, 'collected from 2027', the council's eternal tomorrow." },
